        ...
        if(e.target.firstChild.data == movie.titulo)
        {
          ...
          <form>
            <div class="form-group">
              <label for="exampleFormControlTextarea1">Usuario 1</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" readonly>Muy buena película</textarea>
            </div>
            <div class="form-group">
              <label for="exampleFormControlTextarea1">Usuario 2</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" readonly>Muy buena película x2</textarea>
            </div>
          </form>
          `;
          // console.log(modal)
