...
alert = function (data) {
    ...
    var title;
    var text;
    var type = data.tipo || 'error';
	var cbc = 'btn-primary';
	var confirmButtonText 	= data.textoConfirmar	|| 'Aceptar';
    var cancelButtonText	= data.textoCancelar	|| 'Cancelar';
    ...
    switch (type) {
        case 'error':
            ...
            text = data.texto || 'Algo salió mal :\´(';
            cbc = 'btn-danger';
            break;
        case 'info':
            title = data.titulo || '¡Atención!';
            text = data.texto || 'Algo está pasando';
            cbc = 'btn-info';
            break;
        case 'success':
            title = data.titulo || '¡Perfecto!';
            text = data.texto || 'La acción se realizó exitosamente ';
            cbc = 'btn-success';
            break;
        case 'confirm':
            title = data.titulo || '¡Atención!';
            text = data.texto || '¿Estás seguro?';
            cbc = 'btn-success';
            break;
        default:
            title = data.titulo || '¡Error!';
